# Patient français - Utilisation de PDSm pour le DMP dans le contexte d'EEDS v0.1.0
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ans.fhir.fr.pdsm4dmp|current/StructureDefinition/StructureDefinition-fr-patient.json)
...
```json
{
  ...
  "id" : "fr-patient",
  "url" : "https://interop.esante.gouv.fr/ig/fhir/pdsm4dmp/StructureDefinition/fr-patient",
  "version" : "0.1.0",
  "name" : "FrPatient",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/pdsm4dmp/StructureDefinition/EyeColor"]
      }],
      "mustSupport" : true
    },
    {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://interop.esante.gouv.fr/ig/fhir/pdsm4dmp/ValueSet/ModifiedAdministrativeGender"
      }
    }]
  }
}
