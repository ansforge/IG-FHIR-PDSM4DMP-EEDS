# Type de carte - Utilisation de PDSm pour le DMP dans le contexte d'EEDS v0.1.0
...
```json
{
  ...
  "url" : "https://interop.esante.gouv.fr/ig/fhir/pdsm4dmp/CodeSystem/type-carte-code-system",
  "version" : "0.1.0",
  "name" : "TypeCarteCS",
  "title" : "Type de carte",
  "status" : "draft",
