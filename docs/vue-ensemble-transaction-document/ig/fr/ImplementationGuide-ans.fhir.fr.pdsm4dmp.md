# Resource Utilisation de PDSm  dans le contexte d'EEDS
...
```json
{
  ...
  "id" : "ans.fhir.fr.pdsm4dmp",
  "language" : "fr",
  "url" : "https://interop.esante.gouv.fr/ig/fhir/pdsm4dmp/ImplementationGuide/ans.fhir.fr.pdsm4dmp",
  "version" : "0.1.0",
  "name" : "PDSm4DMP",
  "title" : "Utilisation de PDSm  dans le contexte d'EEDS",
  "status" : "draft",
  "date" : "2026-07-15T13:02:39+00:00",
  ...
  "packageId" : "ans.fhir.fr.pdsm4dmp",
  "license" : "CC0-1.0",
  "fhirVersion" : ["4.0.1"],
  "dependsOn" : [{
    "id" : "hl7tx",
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://interop.esante.gouv.fr/ig/fhir/pdsm4dmp/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    {
      "id" : "LogicalModelPatient",
      "name" : "Modèle logique Patient (XDS)",
      "description" : "Modèle logique Patient XDS"
    },
    {
      "id" : "LogicalModelAuthor",
      "name" : "Modèle logique de l'auteur (Author) et du LegalAuthenticator (XDS)",
      "description" : "Modèle logique l'auteur (Author) et du LegalAuthenticator XDS"
    },
    {
      "id" : "DataType",
      "name" : "Data Type",
      "description" : "Types de base du Modèle logique"
    },
    {
      "id" : "mapping",
      "name" : "Mapping Volet partage vers PDSM",
      "description" : "Mapping du \"Volet Partage de Documents de Santé\" vers \"Partage de Documents de Santé en mobilité (PDSm)\"\""
    },
    {
      "id" : "exemple",
    ...
    },
    {
      ...
      "name" : "AuthorDispositif",
      "description" : "Dispositif dans une structure de santé FINESS",
      "exampleCanonical" : "StructureDefinition/AuthorDocumentEntry",
      "groupingId" : "exemple"
    },
    {
      "extension" : [{
    ...
    },
    {
      ...
      "name" : "AuthorInstitutionCabinetRPPS",
      "description" : "Pour un cabinet RPPS libéral)",
      "exampleCanonical" : "StructureDefinition/AuthorInstitution"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      "name" : "AuthorInstitutionSNR",
      "description" : "NOM EDITEUR^^^^^&1.3.2&ISO^SIREN^^^2704090820",
      "exampleCanonical" : "StructureDefinition/AuthorInstitution"
    },
    {
      "extension" : [{
      ...
      "name" : "AuthorInstitutionStructure",
      "description" : "Pour une structure de santé",
      "exampleCanonical" : "StructureDefinition/AuthorInstitution"
    },
    {
      "extension" : [{
      ...
      "name" : "AuthorPatient",
      "description" : "Patient avec un INS",
      "exampleCanonical" : "StructureDefinition/AuthorDocumentEntry",
      "groupingId" : "exemple"
    },
    {
      ...
      "name" : "AuthorPSCabinetRPPS",
      "description" : "Professionnel en cabinet RPPS libéral",
      "exampleCanonical" : "StructureDefinition/AuthorDocumentEntry",
      "groupingId" : "exemple"
    },
    {
      ...
      "name" : "AuthorStructure",
      "description" : "Professionnel en structure de santé FINESS sans CPS, avec un identifiant interne",
      "exampleCanonical" : "StructureDefinition/AuthorDocumentEntry",
      "groupingId" : "exemple"
    },
    {
    ...
    },
    {
      ...
      "name" : "Exemple TD3.1a - Compte rendu de consultation",
    ...
    },
    {
      ...
      "name" : "Exemple TD3.1a - Document FHIR (Bundle)",
      "description" : "DocumentReference retourné par la transaction ITI-67 (TD3.1a) pour un document au format FHIR (Bundle de type document), avec URL relative vers la ressource Bundle",
      "exampleBoolean" : true,
      "groupingId" : "exemple"
    },
    {
      ...
      "name" : "Exemple TD3.1a - Ordonnance médicale",
    ...
    },
    {
      ...
      "exampleBoolean" : false,
      "groupingId" : "LogicalModelPatient"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
    ...
    "page" : {
      ...
      },
      {
        ...
        },
        {
          "extension" : [{
            "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
            "valueUrl" : "transaction_document_vue_ensemble.html"
          }],
          "nameUrl" : "transaction_document_vue_ensemble.html",
          "title" : "Vue d'ensemble des transactions Document",
          "generation" : "markdown"
        },
        {
          "extension" : [{
      ...
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
          "valueUrl" : "exemples_usage_dmp.html"
        }],
        "nameUrl" : "exemples_usage_dmp.html",
        "title" : "Exemples d'usages DMP",
        "generation" : "markdown"
      },
      {
        "extension" : [{
      ...
      },
      {
        ...
        "page" : [{
          "extension" : [{
            "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
            "valueUrl" : "annexe_identifiants_xds_fhir.html"
          }],
          "nameUrl" : "annexe_identifiants_xds_fhir.html",
          "title" : "Comparatif des identifiants XDS / FHIR",
          "generation" : "markdown"
        },
        {
          "extension" : [{
            "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
            "valueUrl" : "annexe_dates_xds_fhir.html"
          }],
