...
## Exemple DocumentReference: Exemple Annexe - DocumentReference pointant vers un document FHIR (Bundle)
...
**masterIdentifier**: [Uniform Resource Identifier (URI)](http://terminology.hl7.org/5.3.0/NamingSystem-uri.html)/urn:oid:1.2.250.1.213.1.4.8.99999.202
...
**author**: [PractitionerRole : identifier = urn:oid:1.2.250.1.71.4.2.1#899700218896](#hcexample-annexe-docref-fhir/practitionerrole-author-annexe-fhir)

**authenticator**: [PractitionerRole : identifier = urn:oid:1.2.250.1.71.4.2.1#899700218896](#hcexample-annexe-docref-fhir/practitionerrole-author-annexe-fhir)
...
| * | application/fhir+json | Français (France) | [Bundle : identifier = OID:1.2.250.1.213.1.4.8.99999.202; type = document; timestamp = 2024-11-20 11:00:00+0100](Bundle-example-annexe-fhir-document.md) | 4096 | `C/jOTtuBZ37DlUN0mNPjfsu1nHf=` | Synthèse patient 20/11/2024 | 2024-11-20 11:00:00+0100 |
...
| * | 2024-11-20 09:00:00+0100 --> (en cours) | Ambulatory care site | General medicine | [Patient Anonyme (sexe non précisé), Date de Naissance inconnue ( urn:oid:1.2.250.1.213.1.4.8#123456789012345)](#hcexample-annexe-docref-fhir/patient-source-annexe-fhir) |

-------

> **Narratif généré : Patient #patient-source-annexe-fhir**  Patient Anonyme (sexe non précisé), Date de Naissance inconnue ( urn:oid:1.2.250.1.213.1.4.8#123456789012345)
-------

-------

> **Narratif généré : PractitionerRole #practitionerrole-author-annexe-fhir**  
