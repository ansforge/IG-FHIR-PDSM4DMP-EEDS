...
| | | |
| :--- | :--- | :--- |
| [Compte rendu de consultation](DocumentReference-example-td3-1a-cr-consultation.md) | PDF (`application/pdf`) | URL absolue vers une ressource`Binary` |
| [Ordonnance médicale](DocumentReference-example-td3-1a-ordonnance.md) | PDF (`application/pdf`) | URL relative vers une ressource`Binary` |
| [Document FHIR (Bundle)](DocumentReference-example-td3-1a-fhir-document.md) | FHIR JSON (`application/fhir+json`) | URL relative vers une ressource`Bundle` |
