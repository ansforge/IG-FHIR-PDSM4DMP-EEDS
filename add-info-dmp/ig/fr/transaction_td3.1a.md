...
* [Voir l'exemple : DocumentReference - Compte rendu de consultation (TD3.1a)](DocumentReference-example-td3-1a-cr-consultation.md)
* [Voir l'exemple : DocumentReference - Ordonnance médicale (TD3.1a)](DocumentReference-example-td3-1a-ordonnance.md)
