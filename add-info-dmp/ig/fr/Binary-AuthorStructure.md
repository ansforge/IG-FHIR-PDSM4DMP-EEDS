# AuthorStructure - Utilisation de PDSm pour le DMP dans le contexte d'EEDS v0.1.0

## Exemple Binary: AuthorStructure

This content is an example of the [AuthorDocumentEntry (LM)](StructureDefinition-AuthorDocumentEntry.md) Logical Model and is not a FHIR Resource
