# PatientId (LM) - Utilisation de PDSm pour le DMP dans le contexte d'EEDS v0.1.0
...
* Utilise ce/t/te Modèle logique: [Document Entry (LM)](StructureDefinition-DocumentEntry.md), [Folder (LM)](StructureDefinition-Folder.md) and [SubmissionSet (LM)](StructureDefinition-SubmissionSet.md)

Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.pdsm4dmp|current/StructureDefinition/PatientId)
