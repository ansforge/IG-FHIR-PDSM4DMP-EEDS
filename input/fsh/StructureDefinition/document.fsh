...
Description: """
Model logique d'un document
"""

* entryUUID 1..1 Identifier "Identifiant unique du document"
...
* legalAuthenticator 0..1 Identifier "Cette métadonnée représente l'acteur prenant la responsabilité du contenu médical du document" "XCN"
* repositoryUniqueId 1..1 Identifier "Cette métadonnée représente l'identifiant unique global de l'entrepôt de documents dans lequel est stocké le document"
...
* sourcePatientID 1..1 Identifier "Cette métadonnée contient l'identifiant secondaire du patient dans le système d'information du producteur (IPP) ou l'INS, s'il n'y a pas d'identifiant secondaire."
* sourcePatientInfo 1..1 string "Cette métadonnée contient les traits d'identité du patient concerné par le document, connus par le producteur du document. "
...
* patientID 1..1 Identifier "Cette métadonnée représente l’identifiant du patient, en l’occurrence, le matricule INS (NIR ou NIA) du patient. "
* uniqueId 1..1 Identifier "Identifiant unique affecté au document par son créateur. "
* class 1..1 CodeableConcept "class représente la classe du document " "**Class Code**"
...
* practiceSetting 0..1 CodeableConcept "Contexte de l’acte qui a engendré la création du document. " "**Practice Setting**"
