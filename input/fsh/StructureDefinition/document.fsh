...
* legalAuthenticator 1..1 BackboneElement "Cette métadonnée représente l'acteur prenant la responsabilité du contenu médical du document" "XCN"
* legalAuthenticator.XCN1 1..1 identifier "Identifiant (PS_IdNat)"
* legalAuthenticator.XCN2 1..1 string "Nom d'exercice du professionnel, nom du patient, nom du système."
* legalAuthenticator.XCN3 1..1 string "Prénom usuel de la personne (par défaut le premier prénom), nom du modèle pour les dispositifs ou dénomination pour les autres systèmes."
* legalAuthenticator.XCN9 1..1 string " Autorité d’affectation "
* legalAuthenticator.XCN10 1..1 string "Type de nom : Valeur en fonction de l’auteur : • D, pour les personnes physiques, • U, pour les systèmes."
* legalAuthenticator.XCN13 1..1 string "Type d’identifiant"
...
* sourcePatientID 1..1 BackboneElement "Cette métadonnée contient l'identifiant secondaire du patient dans le système d'information du producteur (IPP) ou l'INS, s'il n'y a pas d'identifiant secondaire."
* sourcePatientID.CX1 1..1 Identifier "Identifiant du patient, en l’occurrence, le matricule INS du patient tel que défini dans le cadre juridique"
* sourcePatientID.CX4 1..1 string "Identifiant de l’autorité d’affectation de l’INS utilisé."
* sourcePatientID.CX5 1..1 string " 'NH' pour un maticule INS tel que défini dans le cadre juridique"
* sourcePatientInfo 1..1 BackboneElement "Cette métadonnée contient les traits d'identité du patient concerné par le document, connus par le producteur du document."
* sourcePatientInfo.PID3 0..1 Identifier "Liste des identifiants du patient"
* sourcePatientInfo.PID5 1..* string "Nom et prénoms du patient"
* sourcePatientInfo.PID7 0..1 string "Date/heure de naissance du patient"
* sourcePatientInfo.PID8 0..1 string "Sexe du patient"
* sourcePatientInfo.PID11 0..1 string "Adresse du patient"
* sourcePatientInfo.PID13 0..1 string "Téléphone de la résidence du patient"
* sourcePatientInfo.PID14 0..1 string "Téléphone professionnel du patient"
* sourcePatientInfo.PID15 0..1 string "Langue du patient"
* sourcePatientInfo.PID16 0..1 string "Statut marital du patient"
* sourcePatientInfo.PID18 0..1 string "Numéro de compte du patient"
* sourcePatientInfo.PID21 0..1 string "Identifiant de la mère du patient"
...
* referenceIdList 0..* BackboneElement "Cette métadonnée contient une liste d'un ou plusieurs identifiant(s) d'objet(s) associé(s) au document."
