...
Instance: practitionerrole-author-td31a-cr
...
* contained[+] = practitionerrole-author-td31a-cr
...
* author = Reference(practitionerrole-author-td31a-cr)
* authenticator = Reference(practitionerrole-author-td31a-cr)
