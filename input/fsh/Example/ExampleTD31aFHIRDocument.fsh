...
* contained[0] = patient-source-td31a-fhir
* contained[+] = practitionerrole-author-td31a-fhir
* masterIdentifier.system = "urn:ietf:rfc:3986"
* masterIdentifier.value = "urn:oid:1.2.250.1.213.1.4.8.99999.103"
* status = #current
...
* author = Reference(practitionerrole-author-td31a-fhir)
* authenticator = Reference(practitionerrole-author-td31a-fhir)
* securityLabel = $v3-Confidentiality#N "normal"
* content.attachment.contentType = #application/fhir+json
* content.attachment.language = #fr-FR
* content.attachment.url = "Bundle/fhir-document-td31a"
* content.attachment.size = 8192
...
* context.sourcePatientInfo = Reference(patient-source-td31a-fhir)
