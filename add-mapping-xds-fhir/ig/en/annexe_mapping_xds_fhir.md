...
1. `documentAvailability`(fiche) — accessibilité en ligne/hors-ligne du document, optionnelle, renseignée par le système cible. Non utilisé par le DMP donc pas d'impact.
